...
Roles run sequentially and share the one local model (Ollama keeps it
loaded, so switching roles costs nothing but time). Slower than the
Agent tab; better for big multi-part jobs.
"""
