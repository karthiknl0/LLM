...
from app import imagegen, rag, research
...
SYSTEM_PROMPT = (
    ...
    "you're unsure about, and generate_image when asked to create a "
    "picture. Answer directly from your own knowledge when no tool is "
    "needed. Be concise and practical."
)
...
def agent_chat(message: str, history: list[dict]):
