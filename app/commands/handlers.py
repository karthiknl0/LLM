...
def _cmd_playbooks(_arg: str) -> str:
    from app.content.playbooks import catalog
...
def _cmd_note(arg: str) -> str:
    from app.content.notes import take_note

    return take_note(arg) if arg else "Usage: /note <text>"


def _cmd_notes(_arg: str) -> str:
    from app.content.notes import read_notes
...
def _cmd_approvals(_arg: str) -> str:
    from app.tools.file_ops import list_pending
...
def _cmd_diff(arg: str) -> str:
    from app.tools.git_ops import git_diff
...
def _cmd_vote(arg: str) -> str:
    ...
    from app.security.consistency import self_consistency
...
def _cmd_loop(arg: str) -> str:
    from app.services.scheduler import start_loop
...
def _cmd_loops(_arg: str) -> str:
    from app.services.scheduler import list_loops

    return list_loops()


def _cmd_stoploop(arg: str) -> str:
    from app.services.scheduler import stop_loop
